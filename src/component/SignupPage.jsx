        ...
        <div className="mx-auto px-2 py-8 md:py-2.5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-3 items-start">
            ...
            <button
                  type="submit"
                  disabled={loading}
                  className="w-full inline-flex items-center justify-center rounded-xl bg-[#5336F2] my-2 px-4 py-3 text-white font-medium shadow-sm hover:opacity-95 focus:outline-none focus:ring-offset-2 focus:ring-[#5336F2]"
                >
                  {loading ? (
                    <>

...
//                     <p className="text-xs text-gray-400">We only consider 10,000 to 1,00,000 sqft orders here. More than 1,00,000 buy it from project collaboration.</p>
...
export default function BulkOrderForm3() {
  ...
  const addProduct = () => {
    ...
    const file = productData.image || null;
    ...
    <div className="min-h-screen font-poppins bg-white px-4 sm:px-6 lg:px-16 py-8">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="shadow-2xl p-5 md:p-10 w-full lg:w-[60%]  bg-white rounded-2xl">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div id="product-fields">     <div className=" grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="border mt-4 border-dashed mb-4 border-[#871B58] rounded-lg p-6 text-center text-gray-600 relative bg-white hover:shadow-md transition">
                      ...
                      <p className="text-[#2C2C2C] text-xs font-medium tracking-wide pointer-events-none mb-1">
                        {productData.image ? productData.image.name : "Choose an Image or drag & drop it here"}
                      </p>
                      <span className="text-[8px] block mb-4 text-gray-500 tracking-wide leading-relaxed pointer-events-none">
                        JPEG, PNG and MP4 formats up to 20MB
                      </span>
              ...
              <div className="mb-5 border-1 border-dashed border-[#871B58] rounded-lg p-4 text-center text-gray-500 relative bg-white hover:shadow-md transition">
                ...
                <p className="text-[#2C2C2C] text-xs font-medium tracking-wide pointer-events-none mb-1">{files1?.[0]?.name ? files1[0].name : "Choose a file or drag & drop it here"}</p>
                <span className="text-[8px] block mb-4 text-gray-400 pointer-events-none">Upload PDF BOC(Bulk order)/Tender Files upto 20MB</span>
                <button type="button" onClick={() => document.getElementById("file1").click()} className="inline-block bg-white border font-medium text-sm px-6 py-2 rounded-lg shadow-sm hover:bg-[#871B58] hover:text-white transition">Browse</button>
          ...
          {/* <div className="w-full max-w-5xl mx-auto px-4 bg-white/90 backdrop-blur-md shadow-xl rounded-2xl p-4 border border-gray-100"> */}
          <div className="w-full lg:w-[40%] mx-auto px-4 bg-white/90 backdrop-blur-md shadow-xl rounded-2xl p-4 border border-gray-100">
                        ...
                        <div className="flex justify-between items-start gap-4 w-full">
                          <div className="flex gap-4 items-start flex-1 min-w-0">
                            {(item._preview || item.image) && (
                              <img
                                src={item._preview ?? (typeof item.image === "string" ? item.image : undefined)}
                                alt={`product-${index}`}
                            ...
                            <div className="flex flex-col flex-1 min-w-0">
                              <h4 className="text-sm sm:text-xl font-medium text-black break-words">
                                {item.productName}
                              </h4>
                        ...
                        {item.showDetails && (
                          <div className="mt-3 text-gray-600  space-y-1">
                            <div className="border border-gray-200 rounded-lg p-4 flex flex-col">
                              <p><span className="text-black font-normal  sm:text-[16px]">Selected Finishes:</span> {item.productFinish}</p>
                              <p><span className="text-black font-normal sm:text-[16px]">Selected Unit:</span> {item.unit}</p>
                              <p><span className="text-black font-normal sm:text-[16px]">Selected {item.unit} value
                              </span> : {item.value}</p>
                              <p><span className="text-black font-normal sm:text-[16px]">Selected Thickness:</span> {item.thickness}</p>
                              {item.width && item.height && (
                                <p>
                                  <span className="text-black font-normal sm:text-[16px]">Selected Size:</span> W: {item.width} | H: {item.height}
                                </p>
                              )}
                              <p><span className="text-black font-normal sm:text-[16px]">Estimate Delivery timer:</span>{item.deliveryTime}</p>
                            </div>
                          </div>
                        )}
                      </div>

...
<div className="mb-6">
  ...
  {errors.image && <ErrorText>{errors.image}</ErrorText>}
   ...
   <div className="border mt-4 border-dashed mb-4 border-[#871B58] rounded-lg p-6 text-center text-gray-600 relative bg-white hover:shadow-md transition">  <input    
                id="productImageInput"    
                type="file"    
                className="absolute inset-0 opacity-0 cursor-pointer"    
                accept="image/*"    
...
//   // Field wrapper to apply same gradient/border logic everywhere
//   const FieldWrapper = ({ label, name, optionalText, error, children }) => (
//     <div className="w-full flex flex-col">
//       <label htmlFor={name} className="mb-0.5 text-xs">
//         {label} {optionalText && <span className="text-gray-400 text-sm">{optionalText}</span>}
//       </label>
//       <div
//         className={`rounded-lg p-[1px] transition ${
//           error
...
//         <div
//           className={`flex items-center gap-2 rounded-lg bg-white border transition ${
//             error ? "border-red-500" : "border-[#D7D7D7] focus-within:border-transparent"
//           }`}
//         >
//           {children}
//         </div>
...
//   const inputBaseClass = "flex-1 bg-transparent outline-none border-0 px-3 py-2 text-xs";
...
//                   <FieldWrapper label="Company Type" name="companyType" error={errors.companyType}>
//                     <select
//                       name="companyType"
//                       value={formData.companyType}
//                       onChange={handleChange}
...
//                   <FieldWrapper label="Company Name" name="companyName" error={errors.companyName}>
//                     <input
//                       type="text"
//                       name="companyName"
//                       value={formData.companyName}
...
//               ) : (
//                 <div className="flex flex-col md:flex-row gap-4">
//                   <FieldWrapper label="Company Type" name="companyType" optionalText="(optional)" error={errors.companyType}>
//                     <select name="companyType" value={formData.companyType} onChange={handleChange} className={inputBaseClass}>
//                       <option value="">Choose</option>
//                       <option value="pvt">Private Ltd</option>
//                       <option value="llp">LLP</option>
//                       <option value="proprietor">Proprietor</option>
...
//                   <FieldWrapper label="Company Name" name="companyName" optionalText="(optional)" error={errors.companyName}>
//                     <input
//                       id="companyName"
//                       type="text"
//                       name="companyName"
...
//               {tab === "business" ? (
//                 <FieldWrapper label="GST Number" name="gstNumber" error={errors.gstNumber}>
//                   <input
//                     id="gstNumber"
//                     type="text"
//                     name="gstNumber"
...
//                 </FieldWrapper>
//               ) : (
//                 <FieldWrapper label="GST Number" name="gstNumber" optionalText="(optional)" error={errors.gstNumber}>
//                   <input
//                     id="gstNumber"
//                     type="text"
//                     name="gstNumber"
...
//               <div className="flex flex-col md:flex-row md:justify-between gap-2 w-full">
//                 <div className="w-full flex flex-col md:w-[60%]">
//                   <FieldWrapper label="Full Name" name="fullName" error={errors.fullName}>
...
//                   <FieldWrapper label="Email Address" name="email" error={errors.email}>
//                     <div className="relative w-full">
//                       <input type="email" name="email" value={formData.email} onChange={handleChange} className={inputBaseClass} placeholder="Enter email" />
//                     </div>
//                   </FieldWrapper>
//                 </div>

//                 <div className="flex-1 min-w-[250px]">
//                   <FieldWrapper label="Phone Number" name="phone" error={errors.phone}>
//                     <div className="relative w-full">
//                       <input type="text" name="phone" value={formData.phone} onChange={handleChange} placeholder="Enter phone number" className={inputBaseClass} />
//                     </div>
//                   </FieldWrapper>

//                   <FieldWrapper label="Pincode" name="pinCode" error={errors.pinCode}>
//                     <input type="text" name="pinCode" value={formData.pinCode} onChange={handleChange} placeholder="122204" className={inputBaseClass} />
//                   </FieldWrapper>
//                 </div>
//               </div>

//               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 max-w-5xl mx-auto">
//                 <FieldWrapper label="City" name="city" error={errors.city}>
//                   <input type="text" name="city" value={formData.city} onChange={handleChange} placeholder="Gurugram" className={inputBaseClass} />
//                 </FieldWrapper>

//                 <FieldWrapper label="State" name="state" error={errors.state}>
//                   <input type="text" name="state" value={formData.state} onChange={handleChange} placeholder="Haryana" className={inputBaseClass} />
//                 </FieldWrapper>

//                 <FieldWrapper label="Country" name="country" error={errors.country}>
//                   <input type="text" name="country" value={formData.country} onChange={handleChange} placeholder="India" className={inputBaseClass} />
//                 </FieldWrapper>
//               </div>
...
//                   <FieldWrapper label="Product Name" name="productName" error={errors.productName}>
//                     <input type="text" name="productName" value={formData.productName} onChange={handleChange} placeholder="China White Travertine" className={inputBaseClass} />
//                   </FieldWrapper>

//                   <FieldWrapper label="Product Finish" name="productFinish" error={errors.productFinish}>
//                     <select name="productFinish" value={formData.productFinish} onChange={handleChange} className={inputBaseClass}>
//                       <option value="">Choose finish</option>
//                       <option value="polished">Polished</option>
//                       <option value="honed">Honed</option>
//                       <option value="tumbled">Tumbled</option>
...
//                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
//                   <FieldWrapper label="Select Unit" name="unit" error={errors.unit}>
//                     <select name="unit" value={formData.unit} onChange={handleChange} className={inputBaseClass}>
//                       <option value="">Choose</option>
//                       <option value="sqft">Sqft</option>
//                       <option value="sqm">Sqm</option>
//                     </select>
...
//                   <FieldWrapper label="Enter Value" name="value" error={errors.value}>
//                     <div className="relative w-full md:max-w-sm">
//                       <input type="text" name="value" value={formData.value} onChange={handleChange} placeholder="Type value" className={`${inputBaseClass} w-full pr-12`} />
//                       <span className="absolute right-3 top-1/2 -translate-y-1/2 whitespace-nowrap">{selectedUnit}</span>
//                     </div>
//                   </FieldWrapper>

//                   <FieldWrapper label="Thickness" name="thickness" error={errors.thickness}>
//                     <select name="thickness" value={formData.thickness} onChange={handleChange} className={inputBaseClass}>
//                       <option value="">Choose</option>
//                       <option value="8mm">8MM</option>
//                       <option value="12mm">12MM</option>
//                       <option value="14mm">14MM</option>
...
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                     <div>
//                       <FieldWrapper label="Size of Product (W × H)" name="width" error={errors.width}>
//                         <div className="flex gap-2 w-full">
//                           <input type="text" name="width" placeholder="Width" value={formData.width} onChange={handleChange} className={`${inputBaseClass} md:max-w-sm`} />
//                           <input type="text" name="height" placeholder="Height" value={formData.height} onChange={handleChange} className={`${inputBaseClass} md:max-w-sm`} />
//                         </div>
//                       </FieldWrapper>
//                     </div>

//                     <FieldWrapper label="Estimate Delivery Time" name="deliveryTime" error={errors.deliveryTime}>
//                       <input type="date" name="deliveryTime" value={formData.deliveryTime} onChange={handleChange} className={inputBaseClass} />
//                     </FieldWrapper>
//                   </div>

//                   <FieldWrapper label="Product Image" name="image" error={errors.image}>
...
//                       <p className="text-black text-sm sm:text-base md:text-lg font-medium pointer-events-none mb-1">{productImage ? productImage.name : "Choose an Image or drag & drop it here"}</p>
//                       <span className="text-xs  block mb-4 text-gray-400 pointer-events-none">JPEG, PNG and MP4 formats up to 50MB</span>

//                       <button type="button" onClick={() => document.getElementById("productImageInput").click()} className="inline-block bg-white border font-medium text-sm px-5 py-2 rounded-lg shadow-sm hover:bg-[#871B58] hover:text-white transition">
//                         Browse
//                       </button>
//                     </div>
//                   </FieldWrapper>
...
//                     <button type="button" onClick={addProduct} className="font-inter hover:scale-105 transition-transform duration-200  bg-[#871B58] text-white px-6 py-2 rounded mb-6" disabled={submitting}>
//                       Add this Product
//                     </button>
//                   </div>
//                 </div>
...
//               <FieldWrapper label="Upload BOQ File" name="file1" error={errors.file1}>
...
//                 <div className="mb-4">
//                   <FieldWrapper label="Installation" name="installation" optionalText="(optional)" error={errors.installation}>
//                     <input type="text" name="installation" value={formData.installation} onChange={handleChange} className={`${inputBaseClass} w-full`} placeholder="Enter here" />
//                   </FieldWrapper>
//                 </div>

//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
//                   <FieldWrapper label="Rate list (If Any)" name="file3" error={errors.file3}>
//                     <div className="mb-5 border-1 border-dashed border-[#871B58] rounded-lg p-4 text-center text-gray-500 relative bg-white hover:shadow-md transition">
...
//                   <FieldWrapper label="Image / Video (optional)" name="file2" error={errors.file2}>
//                     <div className="mb-5 border-1 border-dashed border-[#871B58] rounded-lg p-4 text-center text-gray-500 relative bg-white hover:shadow-md transition">
...
//               <FieldWrapper label="Write your query" name="message" error={errors.message}>
//                 <textarea name="message" className={`${inputBaseClass} w-full`} placeholder="Write your message here" rows={3} value={formData.message} onChange={handleChange} />
//               </FieldWrapper>
...
//                           <button onClick={() => removeProduct(index)} aria-label={`Remove ${item.productName}`} className="text-red-500 hover:text-red-700 transition  rounded-full">
...
//                               <p><strong>Selected Thickness:</strong> {item.thickness}</p>
//                               {item.width && item.height && (
//                                 <p><strong>Selected Size:</strong> W: {item.width} | H: {item.height}</p>
//                               )}
//                               <p><strong>Estimate Delivery timer:</strong> {item.deliveryTime}</p>
//                             </div>
//                           </div>
